...
public class GenFileService {
	...
	// Using Java NIO
	public ResultData save(String relTypeCode, int relId, String typeCode, String type2Code, int fileNo, String originFileName, String tempFilePath) {
		...
		Util.moveFile(tempFilePath, destFilePath);
